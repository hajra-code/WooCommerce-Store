...
|-----------------------|-------------------|
| ![Shop Filters](screenshots/shop-filters.png) | ![Cart Discount](screenshots/cart-discount.png) |

| Checkout Page | Live Chat |
|--------------|-----------|
| ![Checkout](screenshots/checkout-payment.png) | ![Chat](screenshots/live-chat.png) |
